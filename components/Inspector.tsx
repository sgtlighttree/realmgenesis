...
import { formatElevation } from '../utils/datum';
...
const Inspector: React.FC<InspectorProps> = ({
  ...
  // D8a: elevation in metres against the presentation datum, replacing the raw
  // 0-1 percentage. Computed once for both the view and edit readouts.
  const elevLabel = cell && world
    ? formatElevation(cell.height, world.params.seaLevel, world.params.maxElevationM)
    : '';
        ...
        {!collapsed && !selectedMarker && enabled && cell && !isEditing && (
          <div className="p-2 text-xs">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1">
              ...
              <div className="text-ink-muted">Elev: <span className="text-ink-strong">{elevLabel}</span></div>
