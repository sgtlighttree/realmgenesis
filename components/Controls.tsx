        ...
        {activeTab === 'export' && (
            <div className="space-y-6">
                 ...
                 <div className="space-y-2">
                    ...
                    <button
                        // Deliberately unstyled: this is a heightmap data export for other tools
                        // (Blender, game engines), not a map to look at.
                ...
                <div className="border-t border-edge-subtle pt-4 space-y-2">
                    ...
                    <button
                        onClick={() => { if (worldData && expProj !== 'dymaxion') void downloadSVG(worldData, viewMode, expProj, 2048, mapStyleId, showHillshade); }}
